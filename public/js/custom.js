(function($) {
	...
	$('.best-product-slider2').owlCarousel({
		items: 1,
		loop: true,
		margin: 24,
		nav: true,
	...
	$('.category-list-slider').owlCarousel({
		items: 1,
		loop: true,
		margin: 0,
		nav: true,
...
// NEWLY JOINED COMPANIES
	...
	function makeTimer() {
		...
		$("#days, #days-p, #days-pp").html(days + "<h6>day</h6>");
		$("#hours, #hours-p, #hours-pp").html(hours + "<h6>hour</h6>");
		$("#minutes, #minutes-p, #minutes-pp").html(minutes + "<h6>min</h6>");
		$("#seconds, #seconds-p, #seconds-pp").html(seconds + "<h6>sec</h6>");
	}
