                    ...
                    if (!k || d.options.allowDuplicates) {
                        if (!(d.items().toString().length + b.length + 1 > d.options.maxInputLength)) {
                            ...
                            if ((d.$element.trigger(l), !l.cancel)) {
                                ...
                                c || d.pushVal(),
                                    (d.options.maxTags === d.itemsArray.length || d.items().toString().length === d.options.maxInputLength) && d.$container.addClass("bootstrap-tagsinput-max"),
            ...
            if (
                ...
                a(".tag", d.$container)
                    ...
                    a("option", d.$element)
                        ...
                        .remove(),
                    -1 !== a.inArray(b, d.itemsArray) && d.itemsArray.splice(a.inArray(b, d.itemsArray), 1);
            }
