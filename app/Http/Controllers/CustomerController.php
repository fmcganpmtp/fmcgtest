...
class CustomerController extends Controller
{
    public function index(Request $request)
    {
        ...
        $roles = Role::all();
        return view('backend/customer/index', compact(  'roles',  'search' ));
    }
    ...
    function list(User $user)
    {
        ...
        $query = $query->where('roles.name','Customer');
        $data = $this->datatable(
            $query,
            function ($query) {
            ...
            function ($rows, $totalFiltered, $totalData) {
                ...
                foreach ($rows as $row) {
                    ...
                    'actions' => view('backend/customer/actions', compact('row'))->render(),
                    ];
                }
                return $data;
            }
    ...
    public function store(Request $request)
    {
        ...
        DB::beginTransaction();
        try {
            $input = $request->only([ 'name', 'email', 'mobile', 'username','status']);
        ...
        return response()->json([
            'jquery' => [
                [
                    ...
                    'method' => 'html',
                    'value' => view('backend/customer/edit', compact(  'roles',  'user' ))->render(),
                ],
            ],
    ...
    public function update(Request $request, User $customer)
    {
        ...
        DB::beginTransaction();
        try {
            $input = $request->only([ 'name', 'email', 'mobile','status']);
            $input['role_id'] = 1;
