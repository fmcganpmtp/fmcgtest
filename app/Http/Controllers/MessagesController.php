...
class MessagescController extends Controller
{
    ...
    public function getLoadLatestMessages(Request $request)
    {
        ...
        $messages = Message::where(function($query) use ($request) {
            $query->where('from_user', Auth::guard('user')->user()->id)->where('to_user', $request->user_id);
        })->orWhere(function ($query) use ($request) {
            $query->where('from_user', $request->user_id)->where('to_user', Auth::guard('user')->user()->id);
    ...
    public function postSendMessage(Request $request)
    {
        ...
        $message->from_user = Auth::guard('user')->user()->id;
        ...
        $message->from_user_id = Auth::guard('user')->user()->id;
