...
class Package extends Model
{
    ...
    protected $fillable = ['name', 'subscription_type','display_order','user_type', 'package_basic_price', 'package_offer_price', 'package_validity', 'package_description', 'general_companyProfile', 'general_companyDashboard', 'general_profileInsights', 'general_accesToMedia', 'market_Search', 'market_uploads', 'market_productRequests', 'market_createProductRequests', 'network_expand', 'network_chat', 'status'];
