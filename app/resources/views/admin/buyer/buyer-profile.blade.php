                 ...
                 <!-- <div class="col-lg-6 col-12">
                  ...
                  <div class="col-lg-6 col-12">
                    <div class="form-group">
                      ...
                      <textArea autocomplete="off" rows="1"  name="address"   class="form-control  {{ $errors->has('address') ? ' is-invalid' : '' }}" > {{ old('address',$address) }}</textArea>
                  ...
                  <span id="txtcompanyzipcode"></span>
                    ...
                    <div class="col-lg-6 col-12">
                      <div class="form-group">
                        ...
                        <input class="form-control" type="text" name="about_company" value="{{ old('about_company',$seller->BuyerCompany->about_company ?? '')  }}"  >
                        <span id="txtcompanylocation"></span>
...
(function(jQuery) {
  ...
  jQuery("#formsubmit").on('submit', function(e) {
            ...
            if(action_type=="Create")
              var url1="{{route('buyerprofile.store')}}";
            else
              var url1="{{route('buyerprofile.update')}}";  
            ...
            formData.append('_token', "{{ csrf_token() }}"); 
                ...
                success: function(data) {
                    ...
                    swal(data, "", "success");
                    $(window).scrollTop(0);
                    var url1="{{route('admin.buyerslist')}}";
