...
<sectiion class="seller-page no-bg seller-container">
           ...
           <div class="card">
              <div class="row">
                ...
                <div class=" col-lg-4  col-12">
                                           <div class="form-group">
                                              <label>Pcs/Box</label>
                                              <input  type="text" class="form-control" name="pcs_box" value="{{old('pcs_box', $product->pcs_box)}}" >
                                           </div>
                </div>
                <div class=" col-lg-4  col-12">
                                           <div class="form-group">
                                              <label>Pcs/Pallet</label>
                                              <input  type="text" class="form-control" name="pcs_pallet" value="{{old('pcs_pallet', $product->pcs_pallet)}}" >
                                           </div>
                </div>
                <div class=" col-lg-4  col-12">
                                           <div class="form-group">
                                              <label>Box/Pallet</label>
                                              <input  type="text" class="form-control" name="box_pallet" value="{{old('box_pallet', $product->box_pallet)}}" >
                                           </div>
                </div>
                <div class=" col-lg-4  col-12">
                                           <div class="form-group">
                                              <label>Lead Time</label>
                                              <input  type="text" class="form-control" name="leadtime" value="{{old('leadtime', $product->leadtime)}}" >
                                           </div>
                </div>
                <!--<div class=" col-lg-4 col-12">-->
                <!--  <div class="form-group">-->
 ...
 @if($product_images)
     ...
     <!--                 @php $selectedCountries = explode(",",$product->available_countries); @endphp-->
