            ...
            <div class="col-lg-6 col-12">
              ...
              <form action="{{ route('reset.password.post') }}" method="POST">
                          ...
                          <div class="form-group row">
                              ...
                              <div class="col-md-6">
                                  <input type="text" id="email_address" class="form-control" autocomplete="off" name="email" required autofocus>
                                  @if ($errors->has('email'))
                          ...
                          <div class="form-group row">
                              ...
                              <div class="col-md-6">
                                  <input type="password" id="password" class="form-control pr-password" autocomplete="off" name="password" required autofocus>
