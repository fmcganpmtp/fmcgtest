               ...
               <div class="product-thumbnail hovereffect">
                  <div class="pro-img">
                     <?php 
                        ...
                        if($product->image_path!='')
                         $prd_img = URL::asset('/uploads/productImages/'.$product->image_path);
                  ...
                  <div class="product-title">
                     ...
                     <h4>
                        ...
                        <?php echo !empty($product->Currency->symbol) ? $product->Currency->symbol : '$' ?> <?php  echo number_format($product->product_price,3); ?> 
