  ...
  $('#btnchangeexpiry').click(function(){
             ...
             if(data==1)
              {
               ...
               swal("Updation Failed", "", "success");

          }  ,
          error: function(XMLHttpRequest, textStatus, errorThrown) { 
               swal(errorThrown, "", "success");
          } 
        })  ;
      }
  });
    ...
    "columnDefs":[
    {
     ...
     
      {
       ...
       "render": function(data,type,full,meta)
      {
        if(full.last_package==full.id)
        return ' <div class="icon-bx rmd"> <a href="JavaScript:void(0);" onclick="sendmessage('+full.subs_id+')" class="snd-rmd"><i class="fa fa-paper-plane-o" aria-hidden="true"></i>Send reminder</a></div><button onclick="fnchangeexpirydate('+full.subs_id+')"  class="change-dt" style="border:0 none !important;"><i class="fa fa-pencil-square-o" aria-hidden="true"></i>Edit subscription expiry date</button>';
      else
        return '';
