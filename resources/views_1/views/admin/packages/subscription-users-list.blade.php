  ...
  $("#search_key").keydown(function (event) { 
    ...
    "columnDefs":[
    {
       ...
       "render": function(data,type,full,meta)
      {
        ...
        return '<div class="icon-bx"> <a href="'+viewurl+data+'"><i class="fa fa-eye" aria-hidden="true"></i></a> <button title="Activate" onclick="fnChangStatus('+full.id+','+Active+')"><i class="fa fa-check-circle-o" aria-hidden="true"></i></button>  <button title="Suspend" onclick="fnChangStatus('+full.id+','+Suspend+')"><i class="fa fa-window-close-o" aria-hidden="true"></i></button></div>';
