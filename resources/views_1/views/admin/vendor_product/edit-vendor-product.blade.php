            ...
            <div class="row">
               <div class="col-lg-12 col-12">
                  <div class="card ">
                     <div class="card-body">
                        <div class="row">
                           <form method="POST" action="{{ route('update.vendorproduct') }}" aria-label="{{ __('Register') }}"  enctype="multipart/form-data">
                              @csrf
                              <div class="row">
                                 ...
                                 <div class=" col-lg-2 col-12">
                                    <div class="form-group">
                                       <label style=" margin-top: 25px;">Currency: <?php echo $product->currency; ?></label>
                                    </div>
                                 </div>
                                 
                                 <div class=" col-lg-4 col-12">
                                    <div class="form-group">
                                       <label for="name" >{{ __('Change currency') }}</label>
                                       <div >
                                        <input type="checkbox"    class="choose_existing_currency"  value="existing_currency"> {{ __('Choose from existing currencies.') }}
                                 ...
                                 <div class=" col-lg-3  col-12 default_currencies" @if(!empty($product->currency_id)) style="display:block;" @else style="display:none;" @endif >
                              <div class="form-group">
                                 ...
                                 <select name="currency_id" id="currency" class="form-control  {{ $errors->has('currency_id') ? ' is-invalid' : '' }}" aria-label="Default select example"  >
                                    ...
                                    <option  @if( $currency->id==$product->currency_id) selected @endif  value="{{$currency->id}}">{{$currency->shortcode}}(<?=$currency->symbol?>)</option> 
                                    @endforeach 
                                    @endif
                                 ...
                                 <div class=" col-lg-2 col-12">
                                    <div class="form-group">
                                       ...
                                       <div >
                                          <input id="product_price"  type="text" step="0.01" class="form-control{{ $errors->has('product_price') ? ' is-invalid' : '' }}" name="product_price" value="{{ $product->product_price }}" >
                                 ...
                                 <div class=" col-lg-3 col-12">
                                    <div class="form-group price_request_outer"  >
                                       <label for="stock_count" >{{ __('Price on request:') }} </label>
                                       <div class="form-field-style"form-field-style" >
                                          <input type="checkbox" name="price_on_request" @if(old('price_on_request',$product->price_on_request)=='Price on request') checked @endif   class="price_request"  value="Price on request"> {{ __('Price on request') }} 
                                       </div>
                                    </div>
                                 </div>
                                 <div class=" col-lg-3 col-12 negotiable_outer" >
                                    <div class="form-group">
                                       <label for="stock_count" >{{ __('Negotiable:') }} </label>
                                       <div class="form-field-style"form-field-style" >
                                          <input type="checkbox" name="price_negotiable" @if(old('price_negotiable',$product->price_negotiable)=='Negotiable') checked @endif   class="negotiable" value="Negotiable"> {{ __('Negotiable') }} 
                                       </div>
                                    </div>
                                 </div>
                                 ...
                                 <div class=" col-lg-6  col-12 " >
                                    <div class="form-group">
                                       ...
                                       <input id="categories" type="text" class="form-control{{ $errors->has('categories') ? ' is-invalid' : '' }}" name="categories" value="{{ $product->categories }}">
                                    </div>
                                 </div>
                                 <div class=" col-lg-6 col-12">
                                    <div class="form-group exist-check"> 
                                    <label>&nbsp;</label>
                                       <input type="checkbox"    class="choose_existing"  value="existing_cat"> {{ __('Choose from existing categories.') }}
                                    </div>
                                 </div>
                                 @endif 
                                 <div class="row default_cats" @if(!empty($cat_selected)) style="display:block;" @else style="display:none;" @endif>
                  ...
                  <div >
                  <input type="checkbox" name="unlimited_stock" {{ $product->unlimited_stock =='Unlimited' ? 'checked' : '' }}  class="unlimited"  value="Unlimited"> {{ __('Unlimited stock') }}
                  </div>
                  </div></div>
                  <div class=" col-lg-6 col-12 stk_cnt"><div class="form-group">
                  <label for="stock_count" >{{ __('Stock Count:') }} </label>
                  <div >
                  <input id="stock_count" type="text" class="form-control{{ $errors->has('stock_count') ? ' is-invalid' : '' }}" name="stock_count" value="{{ round($product->stock_count,2) }}">
                  ...
                  <div >
                  <input id="brands" type="text" class="form-control{{ $errors->has('brands') ? ' is-invalid' : '' }}" name="brands" value="{{ $product->brands }}"  >
                  ...
                  <div >
                  <input id="product_expiry" type="Date" class="form-control{{ $errors->has('product_expiry') ? ' is-invalid' : '' }}" name="product_expiry" value="{{ old('product_expiry',$product->product_expiry) }}"  >
                  ...
                  <div id="image-tumb{{ $product_image->id }}"> <a href="javascript:void(0)" onClick="removeImage({{ $product_image->id }},'tumb')" class=""><span class="red_round remove-input-field"><i class="fa fa-minus-circle" aria-hidden="true"></i></span></a> 
                  <img src="{{URL::asset('/uploads/productImages/'.'/'.$product_image->image_path)}}" class="img-responsive" style="max-height: 50px; max-width: 50px;" alt="" srcset=""> </div>
                  </div>
                  @endif
                  @endforeach
                  @endif
                  ...
                  <div id="image-block{{ $product_image->id }}"> <a href="javascript:void(0)" onClick="removeImage({{ $product_image->id }},'block')" class=""><span class="red_round remove-input-field"><i class="fa fa-minus-circle" aria-hidden="true"></i></span></a> 
                  <img class="img-responsive"  style="max-height: 50px; max-width: 50px;" src="{{URL::asset('/uploads/productImages/'.'/'.$product_image->image_path)}}"  alt="" srcset=""> </div>
                  </div>
                  @endif
                  @endforeach
                  @endif
                  ...
                  <select type="text" multiple placeholder="Available Countries" name="country_ids[]" id='available_countries' class="form-control">
                  @foreach ($countries as $country)
                  <?php
                     if(!empty($product->country_ids))
                     $selectedCountries = explode(",",$product->country_ids);
                     else
                     $selectedCountries =[];
                     ?>
                  ...
                  <div class="form-group">
                  <label>Available Countries:</label>
                  <input  type="text" class="form-control" name="available_countries" value="{{old('available_countries', $product->available_countries)}}"  >
                  </div>
                  </div>
                  @endif
                  <div class=" col-lg-6 col-12"><div class="form-group">
...
<script type="text/javascript">
   ...
   $(".choose_existing_currency").click(function() {
           
         if($(this).prop("checked") == true){
   	  $(".default_currencies").show(); }
                     else {
                            $(".default_currencies").hide();
                       }
                   }); 		
         ...
         .then((willDelete) => {
           if (willDelete) {
                  if(id != 0){
                       $.ajax({
                           type:'post',
                           url:'{{route("delete.PendingSproductImage")}}',
                           data:{id: id, '_token':'{{csrf_token()}}'},
                           success:function(response){ 
                               if(response=='true')            
                                   $('#image-'+type+id).hide();
                                else { $('#image-'+type+id).hide();
                      ...
                      swal('Image remove failed. Something went wrong.', "", "success");
