   ...
   <div class=" rt-form" style="margin-top:20px;">
			...
			<div class="col-lg-4 col-12">
                <div class="form-group">
                  ...
                  <span class="prof_val"> @if(!empty($company_types))
                  @foreach ($company_types as $company_type)
                  @if($user->BuyerCompany->company_type==$company_type->id ) {{$company_type->company_type??''}}@endif
                       @endforeach 
                  @endif</span>
                </div>
			</div>
...
$img_path = asset('/uploads/userImages/').'/'.Auth::guard('user')->user()->profile_pic;
                ...
                <div class="pr-logo">
            <img class="prof_img" src="  {{ $img_path }} "> <a href="javascript: void(0)" class="edit" id="upload_image"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a> </div>
