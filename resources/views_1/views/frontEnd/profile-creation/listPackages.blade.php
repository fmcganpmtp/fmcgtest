   ...
   <div class="pack-prim-out">
		...
		<?php if(++$count % 2) $cls="iq-pricing mb-4 mb-lg-0 text-center  green-hover";
              ...
              <div class="{{$cls}}">
                ...
                <div class="price-footer"><input style="border:0 none !important;" type="submit" class="button" value="View More Details" name="submit"></div>
</form>
...
$(function(){
  $(".account_li").click(function(){ 
      var accounts_id = $(this).attr('id');
      var package_id =$(this).attr('data-id');
      $('.accounts_id'+package_id).val(accounts_id);
      $(this).parents('.drpbuttonli').find('.p1').text($(this).find('a').text()); 
      $(this).parents('.drpbuttonli').find('.p1').val($(this).find('a').text()); 
