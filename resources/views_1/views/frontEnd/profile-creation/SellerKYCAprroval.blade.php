                ...
                <div class="col-lg-4 col-12">
                  <div class="form-group">
                    <div class="file-drop-area form-group">
                      ...
                      <input  type="file" id="file_up" class="file-input form-control" accept=".jfif,.jpg,.jpeg,.png,.gif,.pdf,.doc,.xls,.docx" name="image" required>
              ...
              <div class="col-lg-3 col-12">
             	<div class="file-type-bx">
                   ...
                   @if($status != "Active") 
                     ...
                     <a href="#" data-bs-toggle="tooltip" data-bs-placement="top" title=" {{ $kyc->reason!='' ?$kyc->reason: 'Not Verified' }}" class="kyc-tool-tip"><i class="fa fa-exclamation-circle" aria-hidden="true"></i></a>
...
$('.img_upload').click(function(){ 
 if(!$('#file_up').val()){		
		$('#file_up').attr('required', 'required');
		 $("#loading-image").hide();
 } else { $("#loading-image").show();
