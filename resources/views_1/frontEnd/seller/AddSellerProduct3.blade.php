              ...
              <div class="row">
                ...
                <div class=" col-lg-4  col-12">
                  <div class="form-group">
                    ...
                    <input id="product_expiry" type="Date" class="form-control" name="product_expiry" value="{{old('product_expiry', $product->product_expiry)}}"  autofocus>
                  </div>
                </div>
                <div class=" col-lg-4  col-12">
                  <div class="form-group">
                    <label>location:</label>
                    <input  type="text" class="form-control" name="location" value="{{old('location', $product->location)}}"  autofocus>
                  </div>
                </div>
                <div class=" col-lg-4  col-12">
                           <div class="form-group">
