      ...
      <div class="col-lg-12">
        <div class="pr-bottom ad-pro edt-pro"  >
          ...
          <div class="card prd_diplicate">
            <h3>Edit product</h3>
            <form method="post" action="{{ route('update.PendingSellerProduct') }}" aria-label="{{ __('Update') }}"  enctype="multipart/form-data">
              @csrf
              <div class="row">
                ...
                <div class=" col-lg-2  col-12">
                  <div class="form-group">
                    <label>Product price: <sup id="not_man"  @if($product->
                    ...
                    @if ($errors->has('product_price')) <span class="invalid-feedback" role="alert"> <strong>{{ $errors->first('product_price') }}</strong> </span> @endif </div>
                </div>
                ...
                <div class=" col-lg-4 col-12 price_request_outer">
                  <div class="form-group">
                    ...
                    <div class="form-field-style"form-field-style" >
                      <input class="price_request" type="checkbox" name="price_on_request" @if(old('price_on_request',$product->price_on_request)=='Price on request') checked @endif    value="Price on request"> {{ __('Price on request') }} </div>
                  </div>
                </div>
                <div class=" col-lg-4 col-12 negotiable_outer"  >
                  <div class="form-group">
                    ...
                    <div class="form-field-style"form-field-style" >
                      <input type="checkbox" name="price_negotiable" @if(old('price_negotiable',$product->price_negotiable)=='Negotiable') checked @endif   class="negotiable"  value="Negotiable"> {{ __('Negotiable') }} </div>
                  </div>
                </div>
...
<div class=" col-lg-4 col-12 " >
 ...
 <div class=" col-lg-4 col-12">
                             ...
                             <input type="checkbox"    class="choose_existing"  value="eisting_cat"> {{ __('Choose from existing categories.') }}
                           </div> 
@endif 
...
@endif  
                ...
                <div class=" col-lg-4 col-12">
                  <div class="form-group">
                    ...
                    <div class="form-field-style"form-field-style" >
                      <input type="checkbox" name="unlimited_stock" {{ $product->unlimited_stock =='Unlimited' ? 'checked' : '' }}  class="unlimited"  value="Unlimited"> {{ __('Unlimited stock') }} </div>
                  </div>
                </div>
                <div class="col-lg-4  col-12 stk_cnt">
                  <div class="form-group">
                    ...
                    @if ($errors->has('stock_count')) <span class="invalid-feedback" role="alert"> <strong>{{ $errors->first('stock_count') }}</strong> </span> @endif </div>
                </div>
                <div class=" col-lg-4  col-12">
                  <div class="form-group">
                    <label> Color:</label>
...
$(".choose_existing_currency").click(function() {
 ...
 $("#subcategory option[value='']").attr('selected', true);
 $("#subsubcategory option[value='']").attr('selected', true);
