...
<div class="row">
            ...
            <div class="tableC">
                    <table  id="datatable_pend" class="table table-striped table-bordered " data-page-length='20' cellspacing="0" width="100%">
                <thead>
                  <tr>
                    <th></th>
                    <th>Sl no</th>
...
<script type="text/javascript">
 ...
 var $ = jQuery;
  (function($) {
    ...
    var id = '12';
    var editurl="{{route('edit.pending.sellerProduct', ':id')}}";
    var deleteurl="{{route('delete.PendingSproduct', ':id')}}";
    var viewurl="{{route('view.pending.Sproduct', ':id')}}";
