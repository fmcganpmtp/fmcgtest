...
<html lang="en">
 ...
 <div class="card-body">
                ...
                <div class="round-bx">
                    ...
                    <input placeholder="Enter your email or user name" id="email" type="email" class="{{ $errors->has('email') ? ' is-invalid' : '' }}" name="email" value="{{ old('email') }}" required {{ ($errors->has('email')|| old('email')=='' ) ? 'autofocus' : '' }}>
                    @if ($errors->has('email'))
                ...
                <div class="round-bx">
                    ...
                    <input  placeholder="Enter your password" id="password" type="password" class="{{ $errors->has('password') ? ' is-invalid' : '' }}" name="password" required  {{ $errors->has('password') ? 'autofocus' : '' }}>
                ...
                <div class="log-copy-right"><p>Copyright © 2022 Fmcg land, All rights reserved. </p></div>
