          ...
          <div class="row">
            <div class="col-lg-12 col-12">
              ...
              <div class="row">
				  ...
				  <form method="POST" action="{{ route('update.product') }}" aria-label="{{ __('Register') }}"  enctype="multipart/form-data">
                 ...
                 <select name="currency_id" id="currency" class="form-control  {{ $errors->has('currency_id') ? ' is-invalid' : '' }}" aria-label=""  >
                  ...
                  <div class="form-group">
                    ...
                    <div class="form-field-style"form-field-style" >
                      <input type="checkbox" name="price_on_request" @if(old('price_on_request',$product->price_on_request)=='Price on request') checked @endif   class="price_request"  value="Price on request"> {{ __('Price on request') }} </div>
                  </div>
                </div>
...
@endif  
     ...
     @endforeach 
                ...
                <div class="form-group">
                            ...
                            <div >
                                <input id="company_name" type="text" class="form-control" name="company_name" value="{{ $product->company_name }}"> 
                            </div>
                        </div>
                    </div>
      ...
      .then((willDelete) => {
        if (willDelete) {
               if(id != 0){
                   ...
                   swal('Image remove failed. Something went wrong.', "You clicked the button!", "success");
