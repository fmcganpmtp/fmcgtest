          ...
          <div class="row">
            <div class="col-lg-12 col-12">
              ...
              <div class="row">
				  ...
				  <form method="POST" action="{{ route('seller.update.product') }}" aria-label="{{ __('Register') }}"  enctype="multipart/form-data">
 ...
 <div class=" col-lg-6 col-12"><div class="form-group">
                        ...
                        <div class=" col-lg-6 col-12"><div class="form-group">
                            ...
                            <div >
                             ...
                             <input  value="Unlimited" type="checkbox" name="unlimited_stock" {{ $product->unlimited_stock =='Unlimited' ? 'checked' : '' }} class="unlimited"   value="Unlimited"> {{ __('Unlimited stock') }}
                            </div>
                        </div></div>
