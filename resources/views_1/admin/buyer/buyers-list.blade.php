...
@section('breadcrumb') Buyers List @endsection
@section('content')
          ...
          <div class="row">
            <div class="col-lg-12 col-12">
              <div class="card ">
                ...
                <form action="{{route('admin.buyerslist')}}" method="GET"> 
                    ...
                    <div class="col-lg-2 col-12">
                      ...
                      <select id="status" class="form-control eql-padd">
                        ...
                        <div class="col-lg-6 col-12">
                              ...
                              <a href="{{route('buyerprofile.create')}}" class="bl-btn flt-right1  left-10 pd01"> <i class="fa fa-pencil" aria-hidden="true"></i> Create</a>
                       </div>                     
                        </div>               
                    </div>
                </div>               
...
var $ = jQuery;
  ...
  $(document).ready( function () {
    ...
    var id = '12';
	  var  viewurl="{{route('admin.buyerview', ':id')}}";
    var editurl="{{route('admin.buyeredit', ':id')}}";
    var Blocked="'Blocked'";
    var Active="'Active'";
