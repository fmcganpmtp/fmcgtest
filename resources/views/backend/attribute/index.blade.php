...
<div class="row align-items-center">
    <div class="col-md-4 col-sm-12">
        <div class="mb-1">
            <ol class="breadcrumb breadcrumb-alternate" aria-label="breadcrumbs">
                ...
                <li class="breadcrumb-item active" aria-current="page"><a href="javascript:;">{{ __('Attributes') }}</a></li>
            </ol>
        </div>
        <h2 class="page-title" act-on="click">{{ __('Attributes') }}</h2>
    </div>
    <div class="col-auto ms-auto d-print-none filters">
        <div class="d-flex">
            ...
            @if(hasPermission('attribute.store'))
...
<div class="row">
    <div class="col-lg-12">
         <div class="table-responsive">
            <table act-datatable="{{ route('attribute.list') }}" search="#search" class="table card-table table-vcenter text-nowrap datatable">
            <thead>
        ...
        <div class="modal fixed-left fade" id="create-form" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog modal-dialog-aside" role="document">
                <div class="modal-content fix-padding">
                    <form act-on="submit" act-request="{{ route('attribute.store') }}">
        ...
        <!-- /.modal -->
        @endif
        @if(hasPermission('attribute.edit'))
        <!--  edit form modal  -->
