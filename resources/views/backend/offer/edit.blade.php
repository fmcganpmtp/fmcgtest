<form method="post" act-on="submit" act-request="{{ route('offer.update', ['offer' => $offer->id]) }}">
    <div class="modal-header">
        <h4 class="modal-title">{{ __('Edit Offer') }}</h4>
    </div>
        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <label>{{ __('Name') }}  <span class="text-danger">*</span></label>
                    <div>
                        <input type="text" name="name" value="{{ $offer->name }}"  required   class="form-control">
                        ...
                        <div>
                            <div class="custom-file">
                                ...
                                <div class="preview">
                                    ...
                                    @else
                                    <img src="{{ asset('uploads/' . $offer->image) }}" class="img-thumbnail custom-file-preview" width="150"/>
                                    @endif
                                </div>
