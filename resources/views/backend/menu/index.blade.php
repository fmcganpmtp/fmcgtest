    ...
    <div class="col-md-4 col-sm-12">
        <div class="mb-1">
            <ol class="breadcrumb breadcrumb-alternate" aria-label="breadcrumbs">
                ...
                <li class="breadcrumb-item active" aria-current="page"><a href="javascript:;">{{ __('Menu') }}</a></li>
            </ol>
        </div>
        <h2 class="page-title" act-on="click">{{ __('Menu') }}</h2>
    </div>
...
<div class="row">
    <div class="col-lg-12">
         <div class="table-responsive">
            <table act-datatable="{{ route('menu.list') }}" search="#search" class="table card-table table-vcenter text-nowrap datatable">
            <thead>
                    <tr class="bg-transparent">
                        <th name="id" priority="1" width="8%">SL</th>
                        <th name="business_category_title" width="25%">Business Category</th>
        ...
        <div class="modal fixed-left fade" id="create-form" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog modal-dialog-aside" role="document">
                <div class="modal-content fix-padding">
                    <form act-on="submit" act-request="{{ route('menu.store') }}">
                        <div class="modal-header">
                            <h4 class="modal-title">{{ __('Add Menu') }}</h4>
                                </div>
