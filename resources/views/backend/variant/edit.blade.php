<form method="post" act-on="submit" act-request="{{ route('variant.update', ['variant' => $variant->id]) }}">
        ...
        <div class="row">
            <div class="col-sm-12">
                ...
                <label>{{ __('Name') }}  <span class="text-danger">*</span></label>
                    <div>
                        <input type="text" name="name" value="{{ $variant->name }}"  required   class="form-control">
