...
class {{ $class }}Controller extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('backend/{{ $slug }}/index', compact('search'));
    }
...
@endforeach
        ...
        return view('backend/{{$slug}}/create', compact( @foreach($references as $referenceKey => $reference) '{{ $reference['variable'] }}', @endforeach 'request' ));
    }
...
@endforeach
        ...
        return view('backend/{{$slug}}/edit', compact( @foreach($references as $referenceKey => $reference) '{{ $reference['variable'] }}', @endforeach '{{ $variable}}' ));
    }
