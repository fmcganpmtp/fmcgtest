...
<div class="row align-items-center">
    <div class="col-md-4 col-sm-12">
        <div class="mb-1">
            <ol class="breadcrumb breadcrumb-alternate" aria-label="breadcrumbs">
                ...
                <li class="breadcrumb-item active" aria-current="page"><a href="javascript:;">{{ __('Variant Options') }}</a></li>
            </ol>
        </div>
        <h2 class="page-title" act-on="click">{{ __('Variant Options') }}</h2>
    </div>
    <div class="col-auto ms-auto d-print-none">
        <div class="d-flex">
            ...
            @if(hasPermission('variant.option.store'))
...
<div class="row">
    <div class="col-lg-12">
         <div class="table-responsive">
            <table act-datatable="{{ route('variant.option.list') }}" search="#search" class="table card-table table-vcenter text-nowrap datatable">
            <thead>
                    <tr class="bg-transparent">
                        <th name="id" priority="1" width="8%">SL</th>
                        <th name="variant_name">Variant Name</th>
        ...
        <div class="modal fixed-left fade" id="create-form" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog modal-dialog-aside" role="document">
                <div class="modal-content fix-padding">
                    <form act-on="submit" act-request="{{ route('variant.option.store') }}">
                        <div class="modal-header">
                            <h4 class="modal-title">{{ __('Add Variant Option') }}</h4>
                                </div>
        ...
        <!-- /.modal -->
        @endif
        @if(hasPermission('variant.option.edit'))
        <!--  edit form modal  -->
