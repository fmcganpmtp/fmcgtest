...
@section('body')
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="card px-2">
                <div class="card-body">
                    <form act-on="submit" act-request="{{ route('product.store') }}">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-4 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <div>
                                                    <input type="text" name="variant_option" required placeholder="Eg: 100 gm, 2kg, 1 x 70 gm, Half, Full, 3 count, etc..." class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-4 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <div>
                                                    <input type="text" name="price" class="form-control input-mask" data-inputmask="'alias': 'decimal', 'digits': 2, 'allowMinus': false, 'rightAlign': false">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-4 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <div>
                                                    <input type="text" name="selling_price" class="form-control input-mask" data-inputmask="'alias': 'decimal', 'digits': 2, 'allowMinus': false, 'rightAlign': false">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-4 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <div>
                                                    <input type="text" name="weight" required class="form-control input-mask" data-inputmask="'alias': 'decimal', 'digits': 2, 'allowMinus': false, 'rightAlign': false">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-4 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <div>
                                                    <input type="text" name="max_qty" class="form-control input-mask" data-inputmask="'alias': 'decimal', 'digits': 2, 'allowMinus': false, 'rightAlign': false">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-3 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <div>
                                                    <textarea class="form-control" name="keywords" rows="4"></textarea>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-12 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <div>
                                                    <textarea name="product_description" id="product_description" class="form-control product-description-class">{{ old('product_description') }}</textarea>
                                                </div>
                                            </div>
                                        </div>
...
@section('script')
    ...
    <script>
        initTinyMCE('product_description');
