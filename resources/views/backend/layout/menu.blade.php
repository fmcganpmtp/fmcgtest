    ...
    <ul class="navbar-nav">
        ...
        <li class="nav-item profile">
            <a class="nav-link" href="javascript:void(0);">
                <img src="{{ asset('favicons/apple-touch-icon.png') }}" alt="App Logo"/>
            </a>
        </li>

        <li class="nav-item">
            <a class="nav-link" href="{{ route('dashboard') }}"  data-bs-toggle="tooltip" data-bs-placement="right" title="Dashboard">
        ...
        <li class="nav-item">
            <a class="nav-link" href="{{ route('order') }}"  data-bs-toggle="tooltip" data-bs-placement="right" title="Orders">
        ...
        <li class="nav-item">
            <a class="nav-link" href="{{ route('vendor') }}"  data-bs-toggle="tooltip" data-bs-placement="right" title="Vendors">
        ...
        <li class="nav-item">
            <a class="nav-link" href="{{ route('user') }}"  data-bs-toggle="tooltip" data-bs-placement="right" title="Users">
        ...
        <li class="nav-item">
            <a class="nav-link" href="{{ route('deliverypartner') }}"  data-bs-toggle="tooltip" data-bs-placement="right" title="DeliveryPartrner">
        ...
        <li class="nav-item">
            <a class="nav-link" href="#" data-bs-toggle="modal" data-bs-target="#navigation">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M2.40002 14.4C3.72551 14.4 4.80003 13.3255 4.80003 12C4.80003 10.6745 3.72551 9.59998 2.40002 9.59998C1.07452 9.59998 0 10.6745 0 12C0 13.3255 1.07452 14.4 2.40002 14.4Z" fill="currentColor"/>
                    <path d="M11.9999 14.4C13.3254 14.4 14.3999 13.3255 14.3999 12C14.3999 10.6745 13.3254 9.59998 11.9999 9.59998C10.6744 9.59998 9.59991 10.6745 9.59991 12C9.59991 13.3255 10.6744 14.4 11.9999 14.4Z" fill="currentColor"/>
                    <path d="M21.6 14.4C22.9255 14.4 24 13.3255 24 12C24 10.6745 22.9255 9.59998 21.6 9.59998C20.2745 9.59998 19.2 10.6745 19.2 12C19.2 13.3255 20.2745 14.4 21.6 14.4Z" fill="currentColor"/>
                </svg>
            </a>
        </li>
