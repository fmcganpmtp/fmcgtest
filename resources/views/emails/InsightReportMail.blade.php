...
<h1 style="  font-size: 18px; ">Insight Report ({{$from_date}} - {{$to_date}})</h1>

<p>Profile Visit Count : {{$profile_visit_count}}</p>
<p>Network Request Count : {{$my_networks}}</p>
<p>Chat Request Count : {{$chat_count}}</p>
<p>Product View Count : {{$product_review_count}}</p>
