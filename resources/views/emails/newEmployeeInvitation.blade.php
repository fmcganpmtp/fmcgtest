            ...
            <td>
               ...
               <table width="100%" border="0" cellpadding="0" cellspacing="0" align="center" style="background:#FFF; border:1px solid #f1f1f1;max-width:500px; margin-top:10px; 
                  ...
                  <tr style=" margin:0px 0px; padding:0px;">
                     <td colspan="5">
                        <p style="margin:0px 0px;  padding:0px;border-top-right-radius:10px; text-align:center; border-top-left-radius:10px; border-bottom:3px solid #e86a6a; background:#f5f5f5;"><img src="{{asset('images/logo_mail.png')}}" style="width:250px; text-align:center; margin:30px auto;" /></p>
                     </td>
                  </tr>
                  <tr>
                     <td colspan="5">
                        ...
                        <div  style="margin-left:3%;">
                           <h1 style="  font-size: 18px; ">Welcome to FMCG</h1>
                           <p>{{$company_name}} has send an invitation.</p>
                          <p>Click on the below link to join.</p>
                           <a style="color:#E09D4F;" href="{{route('addPasswordForm', ['token'=>$token,'email'=>$email])}}">Join</a>
                        </div>
                        </p>
                     </td>
                  </tr>
