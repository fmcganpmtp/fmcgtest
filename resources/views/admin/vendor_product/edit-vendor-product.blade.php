                              ...
                              <div class="form-group">
                                 ...
                                 <div class=" col-lg-3 col-12">
                                    <div class="form-group price_request_outer"  >
                                       ...
                                       <div class="form-field-style"form-field-style" >
                                          <input type="checkbox" name="price_on_request" @if(strtolower(trim(old('price_on_request',$product->price_on_request)))==strtolower('Price on request')) checked @endif   class="price_request"  value="Price on request"> {{ __('Price on Request') }} 
                                       </div>
                                    </div>
                                 </div>
                                 ...
                                 <div class=" col-lg-6  col-12 " >
                                    <div class="form-group">
                                     ...
                                     <span id="dldcategory1"></span>
                                    </div>
                                 </div>
                                 <div class=" col-lg-6 col-12">
                                    <div class="form-group exist-check"> 
                                    <label>&nbsp;</label>
                                       <input type="checkbox"    class="choose_existing" name="exist_category"  value="existing_cat"> {{ __('Choose from existing categories.') }}
                  ...
                  @if($product_image->thumbnail=="no" || $product_image->thumbnail=="yes")
                        ...
                        @if(filter_var($product_image->image_path, FILTER_VALIDATE_URL) === FALSE)
                         ...
                         <div class="thumplist45">
                            ...
                            <img class="img-responsive"  style="max-height: 50px; max-width: 50px;" src="{{$product_image->image_path}}"  alt="" srcset=""> </div>
                         </div>
                         @else
                         <div class="thumplist45">
                            <div id="image-block{{ $product_image->id }}"> <a href="javascript:void(0)" onClick="removeImage({{ $product_image->id }},'block')" class=""><span class="red_round remove-input-field"><i class="fa fa-minus-circle" aria-hidden="true"></i></span></a> 
...
<script type="text/javascript">
    ...
    $("#formsubmit").on('submit', function(e) {
            ...
            formData.append('_token', "{{ csrf_token() }}"); 
                ...
                $.ajax({
                type: "post",
                url: "{{ route('update.vendorproduct') }}",
                data: formData,
                ...
                success: function(data) {
                    ...
                    swal(data, "", "success");
                    $(window).scrollTop(0);
                    var url1="{{route('admin.listVendorProduct')}}";
                ...
                error: function (xhr) {
                    ...
                    $("#txtname").empty().append("<p style='color:red'>"+errors.errors.name[0]+"</p>");
                      ...
                      $("#txtname").empty();
                        ...
                        $("#dldcategory1").empty().append("<p style='color:red'>"+errors.errors.categories[0]+"</p>");
                      else
                        $("#dldcategory1").empty();
                      var cattextlen=$('#categories').length;
                    var catflg=0;
                    ...
                    $("#txtproduct_price").empty().append("<p style='color:red'>"+errors.errors.product_price[0]+"</p>");
                      ...
                      $("#txtproduct_price").empty();
                       ...
                       {
                           catflg=1;
                           $("#dldcategory").empty().append("<p style='color:red'>"+errors.errors.categories[0]+"</p>");
                       }  
                       else
                       {
                            catflg=0;
