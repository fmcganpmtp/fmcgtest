...
@endif
 ...
 <button href="javascript:void(0)" onclick="RemoveWishlist({{ $product->id }})" type="button" id="remove_<?=$product->id?>" class="trash" ><i class="fa fa-trash-o" aria-hidden="true" ></i>
Remove</button> 

<button   style="display:none;" href="javascript:void(0)"  id="add_<?=$product->id?>" onclick="addToWishlist({{ $product->id }})" type="button" class="add1" >Add</button> 
