...
<section class="products-area ptb-54 innerpageC pr-req">  
  <div class="container">
      ...
      <div class="col-lg-3">
          ...
          <a href="{{route('add.productrequest')}}" class="default-btn crt-rwq">Create Product
request</a>
  ...
  $fmcg.ajax({
                            ...
                            success:function(data)
                            {
                                  ...
                                  let dataItems = JSON.parse(data);
                                   ...
                                   string+=country_list+'</div><div class="req-msg-btn">';
                                   string+='<a href="javascript:void(0)" onClick="deleteProductReq('+ item.pr_id+' )" class="default-btn delete-pr">';
                                   string+='<i class="fa fa-trash-o" aria-hidden="true"></i>Delete</a>';
                                   string+='<a href="javascript:void(0)" class="default-btn" onclick="ExtendRequest('+ item.pr_id+')" ><i class="fa fa-file-text-o" aria-hidden="true"></i>Extend Request </a>'
                                   string+='</div></div><a  href="'+app_path+'/'+item.pr_id+'" class="edit-link"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a></div></div>'
