...
<?php 
$cls_myNetw =$cls = "";
if (Session::get("tab") == "myNetw")
 $cls_myNetw = "show active";
else
{ $cls = "show active";
$cls_myNetw = ""; } 
 ...
 ?>
                  <ul class="nav nav-tabs" id="myTab" role="tablist">
                     ...
                     <li class="nav-item" role="presentation">
                        <button class="nav-link {{$cls_myNetw}}" id="profile-tab" data-bs-toggle="tab" data-bs-target="#profile" type="button" role="tab" aria-controls="profile" aria-selected="false">My Network</button>
                     </li>
                  </ul>
                  <div class="tab-content" id="myTabContent">
                     ...
                     <div class="tab-pane fade {{$cls_myNetw}}" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                        <div class="top-form-row">
                           <div class="row">
                              <div class="col-lg-3 col-12">
                                 <div class="mb-3">
                              ...
                              <div class="col-lg-3 col-12">
                                 <div class="form-group fm0002">
                                    <select type="text" placeholder="Available Countries" name="available_countries2[]" id='available_countries2' class="form-control" multiple="multiple">
                                       @if($countries_netw)
                                       @foreach($countries_netw as $item)
                                       <option value="{{$item->id}}">{{$item->name}}</option>
                                       @endforeach
                                       @endif
                                    </select>
                              ...
                              <div class="col-lg-3 col-12">
                                 <div class="mb-3">
                                    <input type="text" class="form-control" id="search_by_name1" placeholder="Name/Keyword">
                                 </div>
                              </div>
                           </div>
                        </div>
...
<script type="text/javascript">
   ...
   var network_expand ="";
   var user_type ="";
   @if($view_composer_profile_menu_visible_criteria['network_expand'])
   var network_expand = {{$view_composer_profile_menu_visible_criteria['network_expand']}}; 
   @endif
  ...
  //  $fmcg(".ntwrk-pagi").empty();
  // $fmcg('#company_db_list').empty().html('Loading...');
   $fmcg('#company_db_list').empty();
     $fmcg.ajax({
                           type:'POST',
                           ...
                           data:{
                            ...
                            url: "{{ route('company-dbs') }}" + "?page=" + page,
                           success:function(data) {
                              // console.log(data)
