...
<div class="col-lg-4 col-12"> 
                 ...
                 <?php }
                    ...
                    <!--
                     ...
                     <a href="javascript:void(0)" class="blue-button" onclick="EnableChatRequest( {{$data['main_id']}})" >Message</a>
                     @else
                    <a onclick="showerror()" href="JavaScript:void(0);" class="blue-button">Message</a>
					  @endif
					 --> 
