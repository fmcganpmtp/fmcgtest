...
$today = Carbon::createFromFormat('Y-m-d H:s:i', $today);
 ?>
<sectiion class="seller-page no-bg   inner-page-C my-profile seller-pro edit-top">
  <div class="container">
    <div class="row">
      <div class="col-lg-12">
        <div class="pr-bottom">
          <div class="card sbcrb-dt">
            <div class="row">
              <div class="col-lg-12 col-12 srt-bt">
        ...
        <h2>Subscription Details </h2>
              ...
              @if(count($subscriptions)==0)
                <a class="subscr default-btn sr-rt" href="{{route('package.listing')}}" style="    box-shadow: -1px 3px #888a1a;"><i class="fa fa-telegram" aria-hidden="true"></i>Subscribe Packages </a></h3>
              @endif
              </div>
            </div>
