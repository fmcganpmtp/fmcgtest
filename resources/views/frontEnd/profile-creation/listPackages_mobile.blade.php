...
.credit-card-box .btn-close,  .payment-conf-modal .btn-close { position:absolute; right:0px; top:0px; color:#0ba4e0!important; background:none !important; font-size:20px; font-weight:500; opacity:1; z-index:20;}
...
.switch-field label:last-of-type{border-radius:4px!important;}

.switch-field input:checked + label {border-radius:4px!important;}
.payment-conf-modal .modal-dialog {
    min-width: 95%!important; max-width: 95%!important;
}


.credit-card-box h2, .payment-conf-modal h2 {
    font-weight: 700;
    font-size: 18px;
    margin-bottom: 20px;
}
.credit-card-box h3, .payment-conf-modal h3 {
    font-weight: 300;
    font-size: 15px; margin-bottom:5px;
}

.credit-card-box h4, .payment-conf-modal h4 {
    font-weight: 300;
    font-size: 27px;
    margin: 6px auto;
}
...
.credit-card-box h5, .payment-conf-modal h5 {
    font-size: 15px;
    margin: 20px auto;
}
.payment-Cards {margin:13px auto;}
.credit-card-box img, .payment-Cards img {
    max-width: 199px;
}
...
/*
 .payment-conf-modal .modal-dialog  { max-height: 500px;
    overflow-y: auto;}
}*/
